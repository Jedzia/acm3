...
#  include <sysconfig.h>
#else
#define ACME_RELEASE		"0.94"		// update before release (FIXME)
#endif

#define PERSONALEDITORNAME	"Jed"	// update with your initials (for personal builds)
#define CODENAME	"Codename Nina"	// update before release
#define CHANGE_DATE	"27 May"	// update before release
#define CHANGE_YEAR	"2009"		// update before release
#define HOME_PAGE	"http://acm3.sourceforge.net/"
//#define HOME_PAGE	"http://home.pages.de/~mac_bacon/smorbrod/acme/"
#if  defined( _DEBUG)
	#define DEBUGVHINT  "-Debug Build-"
#else
	#define DEBUGVHINT  "-Release Build-"
#endif
...
static void show_version(bool exit_after) {
	puts(
"This is, ACME, " ACME_RELEASE ", Builder: "PERSONALEDITORNAME", (\"" CODENAME "\"), "DEBUGVHINT", " CHANGE_DATE " " CHANGE_YEAR "\n"
"  \n" PLATFORM_VERSION
	);
	if(exit_after)
		exit(EXIT_SUCCESS);
...
"  Copyright (C) 1998-" CHANGE_YEAR " Marco Baye and Jedzia");
	show_version(FALSE);
	puts(
...
"The newest version of this special version can be found at the ACM3 homepage:\n"
"  " HOME_PAGE "\n"
"\n"
